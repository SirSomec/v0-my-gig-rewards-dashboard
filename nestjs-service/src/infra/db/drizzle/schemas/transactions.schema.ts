...
export const transactions = pgTable('transactions', {
  ...
  type: varchar('type', { length: 32 }).notNull(), // shift | shift_booked | bonus | quest | manual_credit | manual_debit | redemption | raffle_ticket
  ...
  hours: real('hours'),
  /** Дата и время бронирования (для type=shift_booked; фиксируем на своей стороне при записи) */
